...
ActiveRecord::Schema.define(version: 20161204003436) do
  ...
  create_table "subscribem_members", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_subscribem_members_on_account_id"
    t.index ["user_id"], name: "index_subscribem_members_on_user_id"
  end
